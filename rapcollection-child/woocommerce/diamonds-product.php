        ...
        <div class="col-full">
            ...
            <?php
                ...
                if($woof_shortcode) {
				    ...
				    echo do_shortcode("[woof sid='kni_diamonds_filter' tax_only='pa_shape,pa_color,pa_clarity,pa_size,pa_colored-diamonds' by_only=by_price ajax_redraw=0 is_ajax=1 taxonomies=product_cat:".$term_object->term_id." ]");
                }
