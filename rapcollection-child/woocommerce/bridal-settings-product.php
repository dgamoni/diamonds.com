        ...
        <div class="col-full">
            ...
            <?php
                ...
                if($woof_shortcode) {
				    ...
				    echo do_shortcode("[woof sid='kni_diamonds_filter' tax_only='pa_style,pa_metal,pa_shape,pa_price' by_only=by_price ajax_redraw=0 is_ajax=1 taxonomies=product_cat:".$term_object->term_id." ]");
                }
