    ...
    <div id="wl-wrapper" class="product woocommerce"> <!-- product class so woocommerce stuff gets applied in tabs -->
        ...
        <div class="wl-tab-wrap woocommerce-tabs">
            ...
            <ul class="wl-tabs tabs">
                <li class="wl-items-tab"><a href="#tab-wl-items"><?php _e( 'List Jewelry', 'wc_wishlist' ); ?></a></li>
                    ...
                    <form action="<?php $wishlist->the_url_edit(); ?>" method="post" class="wl-form" id="wl-items-form">
                        ...
                        <div class="wl-row">
                            <table width="100%" cellpadding="0" cellspacing="0" class="wl-actions-table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="button small wl-but wl-add-to btn-apply"><?php _e( 'Apply', 'wc_wishlist' ); ?></button>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                        ...
                        <table class="shop_table cart wl-table manage" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <th class="product-thumbnail"  colspan="2"><?php _e( 'Product', 'wc_wishlist' ); ?></th>
                                ...
                                if ( $_product->exists() && $item['quantity'] > 0 ) {
                                    ...
                                    <tr class="cart_table_item">
                                        <td class="product-remove">
                                            <a href="<?php echo woocommerce_wishlist_url_item_remove( $wishlist->id, $wishlist_item_key ); ?>" class=" wlconfirm" title="<?php _e( 'Remove this item from your wishlist', 'wc_wishlist' ); ?>" data-message="<?php esc_attr( _e( 'Are you sure you would like to remove this item from your list?', 'wc_wishlist' ) ); ?>"><!-- &times; --> Remove</a>
                                        </td>
                                        ...
                                        <td class="product-purchase">
                                            <?php if ( $_product->get_type() != 'external' && $_product->is_in_stock() && apply_filters( 'woocommerce_wishlist_user_can_purcahse', true, $_product ) ) : ?>
                                                <a href="<?php echo woocommerce_wishlist_url_item_add_to_cart( $wishlist->id, $wishlist_item_key, $wishlist->get_wishlist_sharing() == 'Shared' ? $wishlist->get_wishlist_sharing_key() : false, 'edit' ); ?>" class="button alt"><?php _e( 'Add to selection', 'wc_wishlist' ); ?></a>
            ...
            <div class="wl-panel panel" id="tab-wl-settings">
                <div class="wl-form">
                    <form action="" enctype="multipart/form-data" method="post">
                        ...
                        <hr/>
                        <p class="form-row">
                            <strong class="privacy-title"><?php _e( 'Privacy Settings', 'wc_wishlist' ); ?>
                        ...
                        <p class="enter-name-capition"><?php _e( 'Enter a name you would like associated with this list.  If your list is public, users can find it by searching for this name.', 'wc_wishlist' ); ?></p>
                        ...
                        <p class="form-row form-row-last">
                            <input type="submit" class="button alt save-button" name="update_wishlist" value="<?php _e( 'Save Changes', 'wc_wishlist' ); ?>">
                        </p>
