...
get_header( 'shop' ); ?>
	...
	<div class="filter_block" data-term_id="<?php echo $term_object->term_id ?>" >
		...
		<div class="col-full">
			...
			<?php 
				...
				echo do_shortcode("[woof sid='kni_diamonds_filter' tax_only='pa_size,pa_color,pa_clarity' by_only=by_price ajax_redraw=0 is_ajax=1 taxonomies=product_cat:".$term_object->term_id." ]"); 
	...
	<div class="categories_block" >
		...
		<div class="col-full products_row">
			<?php echo do_shortcode('[woof_products is_ajax=1 taxonomies=product_cat:'.$term_object->term_id.' orderby='.get_field('diamonds_products_order_by','option').' order='.get_field('diamonds_cat_products_order','option').' ] '); ?>
		</div>		
	...
	<div class="related_products_block" >
		<div class="col-full">
            ...
            $args = array(
                'orderby' => get_field('diamonds_cat_related_products_order_by','option'),
                'order' => get_field('diamonds_cat_related_products_order','option')
            );
