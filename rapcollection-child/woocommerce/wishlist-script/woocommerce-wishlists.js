...
(function ($) {
    ...
    jQuery(document).ready(function ($) {
        ...
        $('.wl-add-to.wl-add-but.button').removeClass('active');
        ...
        $('body').on('click', '.wl-add-to', function (e) {
            ...
            $('.wl-add-to.wl-add-but.button').addClass('active');

            var wlx = $(this).offset().left;
            var wly = $(this).offset().top;
            var wlh = $(this).outerHeight();
            console.log(wlh);
        ...
        function adjust_scroll() {
            ...
            var wlh = _productlink.outerHeight();
            if ($('#wpadminbar ').length) {
                buttontop = buttontop - 28 + wlh;
            }
